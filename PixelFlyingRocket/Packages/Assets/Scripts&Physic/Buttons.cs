...
{
    [Header("Scripts")]
    public startCutScene startCutSceneScript;
    ...
    void EndT()
    {
        if (AchievementsScript.AchievmentsList[0] && AchievementsScript.AchievmentsList[1] && AchievementsScript.AchievmentsList[2] && AchievementsScript.AchievmentsList[3] && AchievementsScript.AchievmentsList[4])
        {
